...
void main() {
  ...
  (x) => x).take(10); // 1. 스트림 만들기 - 1초마다 데이터를 1개씩 만듬, 10개 까지만.
...
/* 6 StreamSubscription을 사용한 에러, done 처리
  var stream = Stream.periodic(Duration(seconds: 3), (x) => x + 11);
...
/*
Stream<int> createStream(List<int> numbers) async* { // async*
